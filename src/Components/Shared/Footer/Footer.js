...
const Footer = () => {
    return (
        <footer className='bg-dark text-white  w-full  py-5 mt-5'>
            <div className='max-w-screen-xl mx-auto px-4'>
                <div className=' flex max-w-xs mx-auto text-center'>
                    <a
                ...
                <div className='text-center text-cyan-600 pt-5 sm:pt-12 font-light flex items-center justify-center'>
                    All Rights Reserved By &copy; Bhaskar The cancer Specialist | 2022-2026
                </div>
            </div>
        </footer>
    )
